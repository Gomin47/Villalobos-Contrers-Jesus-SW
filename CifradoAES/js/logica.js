...
function descifrar128(){
    ...
    if(clave.length!=16){
        alert("La clave no es valida recuerda que es de 16 caracteres");
    }else{
...
function descifrar192(){
    ...
    if(clave.length!=24){
        alert("La clave no es valida recuerda que es de 24 caracteres");
    }else{
        var descifrado = CryptoJS.AES.decrypt(txt, clave);
        document.getElementById("txtdescifrado").innerHTML=descifrado.toString(CryptoJS.enc.Utf8);
...
function descifrar256(){
    ...
    if(clave.length!=32){
        alert("La clave no es valida recuerda que es de 32 caracteres");
    }else{
        var descifrado = CryptoJS.AES.decrypt(txt, clave);
        document.getElementById("txtdescifrado").innerHTML=descifrado.toString(CryptoJS.enc.Utf8);
